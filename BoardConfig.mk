...
TARGET_GLOBAL_CFLAGS += -march=armv7-a -mcpu=cortex-a9 -mtune=cortex-a15 -mfpu=neon -mfloat-abi=softfp
TARGET_GLOBAL_CPPFLAGS += -march=armv7-a -mcpu=cortex-a9 -mtune=cortex-a15 -mfpu=neon -mfloat-abi=softfp
